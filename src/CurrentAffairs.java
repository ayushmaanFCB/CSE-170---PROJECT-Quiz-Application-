...
public class CurrentAffairs {
    ...
    String[] q1 = {"1.   Which country is the biggest trading partner of the European Union ? ?",
            "China", "USA", "India", "United Kingdom"};
    String[] q2 = {"2.   Which Mountain range is often called as the ‘Third Pole’ ?",
            "Karakoram Range", "Alaska Range", "Hindu Kush Range", "Hengduan Mountains Range"};
    String[] q3 = {"3.   Which agency has adopted a political declaration to end AIDS by the year 2030 ?",
            "UN General Assembly", "WHO", "UNICEF", "IMF"};
    String[] q4 = {"4.   What is ‘Uvariopsis dicaprio’, named after Hollywood actor Leonardo DiCaprio ?",
            "A Star", "A Tree", "An Asteroid", "A Satellite"};
    String[] q5 = {"5.   Which aerospace company has announced the ‘DOGE-1 Mission to the Moon’ ?",
            "JAXA", "NASA", "Blue Origin", "SpaceX"};
    ...
    void currentAffairs() {
        ...
        JLabel heading = new JLabel("C U R R E N T   A F F A I R S");
    ...
    void check(){
        ...
        new Score().score(message, "current");
